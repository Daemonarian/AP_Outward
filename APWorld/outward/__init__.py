...
class OutwardWorld(World):
    ...
    def create_items(self):
        ...
        self.create_item(OutwardItemName.COMPASSWOOD_STAFF)
        self.create_item(OutwardItemName.CRACKED_RED_MOON)
        self.create_item(OutwardItemName.DEPOWERED_BLUDGEON)
        self.create_item(OutwardItemName.EXPERIMENTAL_CHAKRAM)
        self.create_item(OutwardItemName.FOSSILIZED_GREATAXE)
        self.create_item(OutwardItemName.KRYPTEIA_TOMB_KEY)
        self.create_item(OutwardItemName.MYRMITAUR_HAVEN_GATE_KEY)
        self.create_item(OutwardItemName.MYSTERIOUS_LONG_BLADE)
        self.create_item(OutwardItemName.RED_LADYS_DAGGER)
        self.create_item(OutwardItemName.RUINED_HALBERD)
        self.create_item(OutwardItemName.RUSTED_SPEAR)
        self.create_item(OutwardItemName.SCARLET_DAGGER)
        self.create_item(OutwardItemName.SCARLET_GEM)
        self.create_item(OutwardItemName.SCARLET_LICHS_IDOL)
        self.create_item(OutwardItemName.SCARRED_DAGGER)
        self.create_item(OutwardItemName.SEALED_MACE)
        self.create_item(OutwardItemName.SLUMBERING_SHIELD)
        self.create_item(OutwardItemName.SMELLY_SEALED_BOX)
        ...
        self.create_item(OutwardItemName.ANGLER_SHIELD)
        ...
        self.create_item(OutwardItemName.BRAND)
        self.create_item(OutwardItemName.BRASS_WOLF_BACKPACK)
        ...
        self.create_item(OutwardItemName.DISTORTED_EXPERIMENT)
        self.create_item(OutwardItemName.DREAMER_HALBERD)
        self.create_item(OutwardItemName.DUTY)
        self.create_item(OutwardItemName.FABULOUS_PALLADIUM_SHIELD)
        self.create_item(OutwardItemName.GEPS_LONGBLADE)
        self.create_item(OutwardItemName.GHOST_PARALLEL)
        self.create_item(OutwardItemName.GILDED_SHIVER_OF_TRAMONTANE)
        ...
        self.create_item(OutwardItemName.GRIND)
        ...
        self.create_item(OutwardItemName.LIGHT_MENDERS_LEXICON)
        self.create_item(OutwardItemName.MEFINOS_TRADE_BACKPACK)
        self.create_item(OutwardItemName.MERTONS_FIREPOKER)
        self.create_item(OutwardItemName.MERTONS_FIREPOKER)
        self.create_item(OutwardItemName.MERTONS_RIBCAGE)
        self.create_item(OutwardItemName.MERTONS_SHINBONES)
        self.create_item(OutwardItemName.MERTONS_SKULL)
        self.create_item(OutwardItemName.MURMURE)
        ...
        self.create_item(OutwardItemName.PEARLESCENT_MAIL)
        ...
        self.create_item(OutwardItemName.PORCELAIN_FISTS)
        self.create_item(OutwardItemName.REVENANT_MOON)
        self.create_item(OutwardItemName.ROTWOOD_STAFF)
        ...
        self.create_item(OutwardItemName.SANDROSE)
        self.create_item(OutwardItemName.SCARLET_BOOTS)
        self.create_item(OutwardItemName.SCARLET_MASK)
        self.create_item(OutwardItemName.SCARLET_ROBES)
        self.create_item(OutwardItemName.SCEPTER_OF_THE_CRUEL_PRIEST)
        self.create_item(OutwardItemName.SHRIEK)
        self.create_item(OutwardItemName.SKYCROWN_MACE)
        self.create_item(OutwardItemName.STARCHILD_CLAYMORE)
        ...
        self.create_item(OutwardItemName.THRICE_WROUGHT_HALBERD)
        self.create_item(OutwardItemName.TOKEBAKICIT)
        ...
        self.create_item(OutwardItemName.WERLIG_SPEAR)
        self.create_item(OutwardItemName.WILL_O_WISP)
        self.create_item(OutwardItemName.WORLDEDGE_GREATAXE)
        self.create_item(OutwardItemName.ZHORNS_DEMON_SHIELD)
        self.create_item(OutwardItemName.ZHORNS_GLOWSTONE_DAGGER)
        self.create_item(OutwardItemName.ZHORNS_HUNTING_BACKPACK)
