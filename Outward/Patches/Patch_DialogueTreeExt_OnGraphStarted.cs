...
namespace OutwardArchipelago.Patches
{
    ...
    {
        private static void Prefix(DialogueTreeExt __instance) => OutwardArchipelagoMod.Log.LogDebug($"[DialogueTreeExt.OnGraphStarted] {DialogueTreeID.FromTree(__instance)}");
    }
}
