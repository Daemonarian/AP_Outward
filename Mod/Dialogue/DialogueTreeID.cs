...
namespace OutwardArchipelago.Dialogue
{
    internal class DialogueTreeID
    {
        ...
        public static readonly DialogueTreeID RustedSpear = FromHash(0xDD147324CF2E6149);
        public static readonly DialogueTreeID SagardBattleborn_BC_AncestralPeacemaker = FromName("Dialogue_SagardBattleborn_BC_AncestralPeacemaker");
        public static readonly DialogueTreeID SagardBattleborn_BC_MixedLegacies = FromName("Dialogue_SagardBattleborn_BC_MixedLegacies");
        public static readonly DialogueTreeID SagardBattleborn_BC_WhisperingBones = FromName("Dialogue_SagardBattleborn_BC_WhisperingBones");
        public static readonly DialogueTreeID SagardBattleborn_HM_HallowPeacemaker = FromName("Dialogue_SagardBattleborn_HM_HallowPeacemaker");
        public static readonly DialogueTreeID SagardBattleborn_Neut_Initial = FromName("Dialogue_SagardBattleborn_Neut_Initial");
        public static readonly DialogueTreeID SagardBattleborn_Neut_Prequest = FromName("Dialogue_SagardBattleborn_Neut_Prequest");
        public static readonly DialogueTreeID SagardBattleborn_Neut_Purifier = FromName("Dialogue_SagardBattleborn_Neut_Purifier");
        public static readonly DialogueTreeID SimeonKing_HK_HeroPeacemaker = FromName("Dialogue_SimeonKing_HK_HeroPeacemaker");
        public static readonly DialogueTreeID SimeonKing_HK_MouthToFeed = FromName("Dialogue_SimeonKing_HK_MouthToFeed");
        public static readonly DialogueTreeID SimeonKing_HK_SandCorsair = FromName("Dialogue_SimeonKing_HK_SandCorsair");
        public static readonly DialogueTreeID SimeonKing_HK_TendFlame = FromName("Dialogue_SimeonKing_HK_TendFlame");
        public static readonly DialogueTreeID SimeonKing_HM_HallowPeacemaker = FromName("Dialogue_SimeonKing_HM_HallowPeacemaker");
        public static readonly DialogueTreeID SimeonKing_Neut_Initial = FromName("Dialogue_SimeonKing_Neut_Initial");
        public static readonly DialogueTreeID SimeonKing_Neut_Prequest = FromName("Dialogue_SimeonKing_Neut_Prequest");
        public static readonly DialogueTreeID Soeran_Neut_Initial = FromName("Dialogue_Soeran_Neut_Initial");
        public static readonly DialogueTreeID Soeran_Neut_Prequest = FromName("Dialogue_Soeran_Neut_Prequest");
        ...
        public static readonly DialogueTreeID SunfallAxe = FromHash(0x730EC0152D5FD939);
        public static readonly DialogueTreeID ThriceWroughtHalberd = FromHash(0x1EB6873BB813DB9A);
